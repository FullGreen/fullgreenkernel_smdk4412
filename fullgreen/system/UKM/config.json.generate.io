	...
	elements:[
		...
		},
		{
			SOptionList:{
				...
				default:"$(FK_bracket /sys/block/mmcblk0/queue/scheduler)",
				action:"FK_bracket /sys/block/mmcblk0/queue/scheduler",
				values:[
					$(
		...
		},
		{
			SSeekBar:{
				...
				default:$(FK_generic /sys/block/mmcblk0/queue/read_ahead_kb),
				action:"FK_generic /sys/block/mmcblk0/queue/read_ahead_kb"
			}
		},
		{
			SCheckBox:{
				...
				default:$(FK_generic /sys/block/mmcblk0/queue/add_random),
				action:"FK_generic /sys/block/mmcblk0/queue/add_random"
			}
		},
		$(
...
cat << _EOF
				...
				},
				{
					SOptionList:{
						...
						description:"The selected scheduling algorithm decides which order block I/O operations will be submitted to storage volumes.",
						default:"$(FK_bracket /sys/block/mmcblk1/queue/scheduler)",
						action:"FK_bracket /sys/block/mmcblk1/queue/scheduler",
						values:[
							$(
				...
				},
				{
					SSeekBar:{
						...
						description:"This setting controls how much extra data the operating system reads from disk when performing I/O operations.",
						max:2048, min:128, unit:" kB", step:128,
						default:$(FK_generic /sys/block/mmcblk1/queue/read_ahead_kb),
						action:"FK_generic /sys/block/mmcblk1/queue/read_ahead_kb"
					}
				},
				{
					SCheckBox:{
						...
						description:"By default, the amount of time to write a block is used as source of entropy. This behaviour can be disabled in order to improve I/O speed for the cost of potential lower kernel's entropy pool",
						default:$(FK_generic /sys/block/mmcblk1/queue/add_random),
						action:"FK_generic /sys/block/mmcblk1/queue/add_random"
					}
				},
_EOF
			fi
...
cat << _EOF
				...
				},
				{
					SCheckBox:{
						...
						default:$(FK_generic /sys/kernel/dyn_fsync/Dyn_fsync_active),
						action:"FK_generic /sys/kernel/dyn_fsync/Dyn_fsync_active"
					}
				},
_EOF
			fi
